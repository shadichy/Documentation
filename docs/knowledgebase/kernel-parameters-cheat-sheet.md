...
If you want to know how to set these, check out [Setup kernel's command-line parameters](/configuration/kernel-parameters).

## Booting & Startup

!!!danger
    These parameters are very important. `SRC` is the **must-have** parameters on your installation of BlissOS. the rest of `androidboot.*` options are **must-have** if you are using [AB-mode](/installation/manual/the-basics/#for-ab-mode-deployment).

{{ read_csv('assets/csv/cmdline_booting.csv') }}
...
{{ read_csv('assets/csv/cmdline_debug.csv') }}
...
{{ read_csv('assets/csv/cmdline_codecs.csv') }}
...
{{ read_csv('assets/csv/cmdline_ntfs3.csv') }}

### Miscellaneous

{{ read_csv('assets/csv/cmdline_disk_misc.csv') }}

## Networking

{{ read_csv('assets/csv/cmdline_network.csv') }}

## Sensors

{{ read_csv('assets/csv/cmdline_sensors.csv') }}

## Power
### Battery

{{ read_csv('assets/csv/cmdline_battery.csv') }}

### Miscellaneous

{{ read_csv('assets/csv/cmdline_power_misc.csv') }}

## Audio

{{ read_csv('assets/csv/cmdline_audio.csv') }}

## Bluetooth

{{ read_csv('assets/csv/cmdline_bluetooth.csv') }}
...
{{ read_csv('assets/csv/cmdline_graphics.csv') }}
...
{{ read_csv('assets/csv/cmdline_graphics_celadon.csv') }}

## Recovery

{{ read_csv('assets/csv/cmdline_recovery.csv') }}

## Camera

{{ read_csv('assets/csv/cmdline_camera.csv') }}

## Miscellaneous

{{ read_csv('assets/csv/cmdline_misc.csv') }}
